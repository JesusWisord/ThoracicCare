...
// Module
exports.push([module.i, ".Header_icon__kgNS5{\n  height: 30px;\n  width: 30px;\n  color: #1d5b9c;\n  margin-right: 30px;\n}\n\n.Header_header__CSn5y{\n  background-color: #D6E9F3;\n}\n\n@media screen and (max-width: 350px){\n  .Header_icon__kgNS5{\n    margin-right: 10px;\n  }\n}", "",{"version":3,"sources":["Header.module.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,WAAW;EACX,cAAc;EACd,kBAAkB;AACpB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE;IACE,kBAAkB;EACpB;AACF","file":"Header.module.css","sourcesContent":[".icon{\n  height: 30px;\n  width: 30px;\n  color: #1d5b9c;\n  margin-right: 30px;\n}\n\n.header{\n  background-color: #D6E9F3;\n}\n\n@media screen and (max-width: 350px){\n  .icon{\n    margin-right: 10px;\n  }\n}"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=index.js.105f9f3d3d4e0f681bb1.hot-update.js.map