...
// Module
exports.push([module.i, ".Servicios_serviciosContainer__JVBQi{\n  background-color: var(--first-brand-color);\n  padding-top: 50px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.Servicios_cardContainer__Xk0ar{\n  display: grid;\n  width: 80%;\n  grid-template-columns: 1fr 1fr 1fr;\n  justify-items: center;\n  align-items: center;\n}", "",{"version":3,"sources":["Servicios.module.css"],"names":[],"mappings":"AAAA;EACE,0CAA0C;EAC1C,iBAAiB;EACjB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,kCAAkC;EAClC,qBAAqB;EACrB,mBAAmB;AACrB","file":"Servicios.module.css","sourcesContent":[".serviciosContainer{\n  background-color: var(--first-brand-color);\n  padding-top: 50px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.cardContainer{\n  display: grid;\n  width: 80%;\n  grid-template-columns: 1fr 1fr 1fr;\n  justify-items: center;\n  align-items: center;\n}"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=index.js.5b63e702bce17c116e03.hot-update.js.map