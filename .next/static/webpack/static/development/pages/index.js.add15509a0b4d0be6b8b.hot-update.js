...
// Module
exports.push([module.i, ".Servicios_serviciosContainer__JVBQi{\n  background-color: var(--first-brand-color);\n  padding-top: 50px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.Servicios_cardContainer__Xk0ar{\n  display: grid;\n  width: 80%;\n  grid-template-columns: 1fr 1fr 1fr;\n}\n\n.Servicios_cardItem__12fEz {\n  margin: 0 auto;\n}", "",{"version":3,"sources":["Servicios.module.css"],"names":[],"mappings":"AAAA;EACE,0CAA0C;EAC1C,iBAAiB;EACjB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,kCAAkC;AACpC;;AAEA;EACE,cAAc;AAChB","file":"Servicios.module.css","sourcesContent":[".serviciosContainer{\n  background-color: var(--first-brand-color);\n  padding-top: 50px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.cardContainer{\n  display: grid;\n  width: 80%;\n  grid-template-columns: 1fr 1fr 1fr;\n}\n\n.cardItem {\n  margin: 0 auto;\n}"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=index.js.add15509a0b4d0be6b8b.hot-update.js.map