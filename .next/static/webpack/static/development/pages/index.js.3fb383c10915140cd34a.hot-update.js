...
// Module
exports.push([module.i, ".Servicios_serviciosContainer__JVBQi{\n  background-color: var(--first-brand-color);\n  margin-top: 50px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.Servicios_cardContainer__Xk0ar{\n  display: grid;\n  width: 80%;\n  grid-template-columns: 1fr 1fr 1fr;\n}", "",{"version":3,"sources":["Servicios.module.css"],"names":[],"mappings":"AAAA;EACE,0CAA0C;EAC1C,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,UAAU;EACV,kCAAkC;AACpC","file":"Servicios.module.css","sourcesContent":[".serviciosContainer{\n  background-color: var(--first-brand-color);\n  margin-top: 50px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.cardContainer{\n  display: grid;\n  width: 80%;\n  grid-template-columns: 1fr 1fr 1fr;\n}"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=index.js.3fb383c10915140cd34a.hot-update.js.map